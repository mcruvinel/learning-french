...
export const lesson01: Lesson = {
  ...
  phrases: [
    {
      ...
      tip: 'O “on” é uma vogal nasal parecida com a de “bom”, mas sem o “u” que o português põe no fim (“bõu”): a boca fica parada. O “j” é o de “já”. O “ou” soa como “u”. O “r” final é pronunciado — suave, no fundo da garganta. Não engula como em “falá”.',
      ipa: 'bɔ̃.ʒuʁ',
    ...
    },
    {
      ...
      fr: 'Au revoir',
      pt: 'Tchau / Até logo',
      tip: '“au” soa como “ô”. O “e” de “re” é curto e fraco, quase engolido. “oir” de novo é “uár”, com o “r” final pronunciado.',
      ipa: 'o ʁə.vwaʁ',
    },
    {
      id: 'merci',
      fr: 'Merci',
      pt: 'Obrigado',
      tip: '“e” aberto, como “é”. As duas sílabas têm quase o mesmo peso. Não force a primeira como em “MÉR-ci”.',
      ipa: 'mɛʁ.si',
    ...
    },
    {
      ...
      fr: "S'il vous plaît",
      pt: 'Por favor',
      tip: '“s’il” termina num “l” de verdade, com a língua tocando atrás dos dentes, não em “u” como em “Brasiu”. “ou” = “u”. “aî” = “é”. O “t” final não é pronunciado.',
      ipa: 'sil vu plɛ',
    ...
    },
    {
      ...
      fr: 'Non',
      pt: 'Não',
      tip: 'Vogal nasal, a mesma de Bonjour. Não é o “não” do português: sem o “u” no fim, e o “n” final não soa como consoante separada.',
      ipa: 'nɔ̃',
    },
    {
      id: 'excusez-moi',
      ...
      ipa: 'ɛk.sky.ze mwa',
      note: 'Para chamar a atenção de alguém antes de uma pergunta. Para passar por alguém no metrô ou depois de esbarrar, os franceses costumam dizer só “Pardon”.',
    },
    {
      id: 'je-m-appelle',
      fr: "Je m'appelle Matheus.",
      pt: 'Meu nome é Matheus.',
      tip: '“je” tem um “e” curto e fraco. “appelle” termina em “él”, com “l” de verdade (língua nos dentes, não “éu”); o último “e” não é pronunciado. Diga seu nome do jeito que você diz em português.',
      ipa: 'ʒə ma.pɛl',
    ...
    },
    {
      ...
      pt: 'Sou brasileiro.',
      tip: '“suis” é uma sílaba: o “u” francês deslizando rápido para “i”. “bré” tem “é” fechado, como “ê”. O “ien” final é nasal, perto do “em” de “bem”, mas mais aberto e sem o “i” que o português põe no fim (“bẽi”).',
    ...
    },
    {
      ...
      tip: '“parle” termina em “l” de verdade: o “e” final some. “un” é nasal. “peu”: diga “ê” arredondando os lábios. Em “français”, o “an” é nasal, perto do “ã” de “maçã” com a boca mais aberta; o “ç” soa “s” e o “s” final é mudo.',
  ...
  pronunciationNotes: [
    'As sílabas têm quase o mesmo peso; a última de cada grupo fica um pouco mais longa. Nunca force a primeira: nada de “MÉR-ci”.',
    'Consoantes finais normalmente ficam mudas: plaî(t), françai(s), vou(s). Mas “r” e “l” finais soam: bonjou(r), s’i(l).',
    'O “r” francês é feito no fundo da garganta, perto do “rr” de “carro” como a maioria dos brasileiros fala, só que mais suave e com a voz vibrando. Não é o “r” de “caro”.',
    'O “l” no fim da sílaba é “l” de verdade, com a língua nos dentes: nunca “u” como em “Brasiu”.',
    '“oi” = “uá”, “ou” = “u”, “au” = “ô”. O “u” francês é um “i” com lábios de “u”. Vogais nasais não terminam em “u” ou “i” como em “bom” e “bem”.',
  ],
  nextLesson:
  ...
  steps: [
    ...
    },
    {
      ...
      paragraphs: [
        'Sílabas com quase o mesmo peso; a última fica um pouco mais longa. Nada de “MÉR-ci”.',
        'Consoantes finais normalmente ficam mudas: o “t” de plaît e o “s” de vous não soam. Exceção de hoje: o “r” final soa (bonjour, bonsoir, au revoir), e o “l” também (s’il).',
        'O “r” francês vem do fundo da garganta, perto do “rr” de “carro”, mais suave e com voz. E nunca engula o “r” final como em “falá”.',
    ...
    },
    {
      ...
      options: ['Olá / Bom dia / Boa tarde', 'Tchau', 'Obrigado', 'Por favor'],
      answerIndex: 0,
    },
    {
      kind: 'choice',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Você vai ouvir “Bonjour, monsieur” e “Bonjour, madame”. Responder assim é ainda mais educado, mas só Bonjour já está certo.',
      ],
    },
    {
      kind: 'phrases',
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          fr: "Bonsoir ! C'est à quel nom ?",
          pt: 'Boa noite! Em nome de quem (é a reserva)?',
        },
        {
          who: 'you',
          ...
          options: [
            ...
            { fr: 'Merci.', correct: false, feedback: 'Ela perguntou em nome de quem é a reserva.' },
            {
              fr: "Je m'appelle Matheus.",
              correct: true,
              feedback: 'Isso. Você vai ouvir “C’est à quel nom ?” em hotéis e restaurantes também; só dizer o nome já basta.',
            },
          ],
        },
        {
          who: 'them',
          speaker: 'Recepcionista',
          fr: "Très bien. Vous venez d'où ?",
          pt: 'Muito bem. O senhor vem de onde?',
        },
        {
          who: 'you',
          ...
          options: [
            {
              ...
              correct: true,
              feedback: 'Resposta honesta e educada. Muitas vezes a pessoa passa a falar mais devagar.',
            },
        ...
        },
        {
          who: 'them',
          speaker: 'Recepcionista',
          fr: 'Pas de souci. Votre cours est demain à neuf heures. Bonne soirée !',
          pt: 'Sem problema. Sua aula é amanhã às nove horas. Tenha uma boa noite!',
        },
        {
          who: 'you',
